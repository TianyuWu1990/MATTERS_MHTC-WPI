...
CREATE OR REPLACE FUNCTION mhtc_sch.getmetricsbyparent(IN parentids integer[] DEFAULT '{}'::integer[])
  RETURNS TABLE("Id" integer, "Name" character varying, "Visible" boolean, "IsCalculated" boolean, "DataType" character varying, "DisplayName" character varying, "URL" character varying, "Source" character varying, "TrendType" character varying, "ParentId" integer, "DisplayOrder" integer) AS
$BODY$
BEGIN
