...
<td >
	<div class="btn-group btn-group-sm">
		...
		<ul class="dropdown-menu" role="menu">
			...
			<li><a href="#" onClick="as.toggleMultiSelect(${fn:escapeXml(data_value.metric.id)}, 1);">Compare to Select States</a></li>
		    ...
		    <li><a data-toggle="modal" data-target="#myModalHeatMap" onClick="as.showHeatMapGraph(${fn:escapeXml(data_value.metric.id)},${style_values},'#mbodyHeatMap',-1)">Display Heatmap</a></li>
