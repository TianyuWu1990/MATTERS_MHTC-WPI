...
<div id="page-wrapper">
	...
	<div class="row">
		<div class="col-lg-12">
			<p>
				The <b>Administrator Management</b> page allows and admin to perform
				account maintenance, such as resetting a user's password or changing
				their own, as well as the ability to create a new admin account.
			</p>
		</div>
	</div>
	<div class="row">
		<div class="col-lg-4">
			<div class="panel panel-primary">
				<div class="panel-heading">Create a new administator account</div>
					...
					<div id="admin-add-form">
						<form method="POST" action="admin/account/create">
							...
							<div class="form-group">
								<div class="input-group">
									<span class="input-group-addon"><i
										class="fa fa-info fa-fw"></i></span> <input type="text"
							...
							<button type="submit" class="btn btn-success">Add Admin
								Account</button>
						</form>
					</div>
				</div>
					...
					<div id="admin-change-my-pwd">
						<form method="POST" action="admin/account/change-password">
							...
							<div class="form-group">
								<div class="input-group">
									<span class="input-group-addon"><i
										class="fa fa-key fa-fw"></i></span> <input type="text"
							...
							<button type="submit" class="btn btn-success">Change my
								password</button>
						</form>
					</div>
				</div>
		...
		<div class="col-lg-4">
			<div class="panel panel-primary">
				<div class="panel-heading">Reset a user's password</div>
				<div class="panel-body">
						...
						<form method="POST" action="admin/account/reset-password">
							...
							<div class="form-group">
								<div class="input-group">
									<span class="input-group-addon"><i
										class="fa fa-user fa-fw"></i></span> <input type="text"
										class="form-control" name="resetUsername"
										placeholder="Username">
								</div>
							</div>
							<button type="submit" class="btn btn-success">Reset
								password for this user</button>
						</form>
					</div>
				</div>
			</div>
