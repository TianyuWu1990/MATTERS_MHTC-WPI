...
var CM = (function($) {
	...
	Chart.prototype.showMultiGraph = function(states) {
	    	...
	    	var query = DQ.create().addState(states.map(function(state){return ""+States.getStateByAbbreviation(state).getId()})).addMetric(Metrics.getMetricByID(as.currentind).getId());
