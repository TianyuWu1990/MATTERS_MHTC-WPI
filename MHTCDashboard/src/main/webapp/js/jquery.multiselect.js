...
(function($, undefined) {
  ...
  $.widget("ech.multiselect", {
    ...
    _create: function() {
      ...
      var button = (this.button = $('<button type="button"><span class="placeholder"></span><div class="pull-right" "></div></button>'))
      ...
      el.find('option').each(function(i) {
        ...
        if(parent.tagName === 'OPTGROUP') {
          ...
          if($.inArray(optLabel, optgroups) === -1) {
            html += '<li class="ui-multiselect-optgroup-label ' + parent.className + '"  data-toggle="tooltip" title="Click to select all states"><a href="#">' + optLabel + '</a></li>';
