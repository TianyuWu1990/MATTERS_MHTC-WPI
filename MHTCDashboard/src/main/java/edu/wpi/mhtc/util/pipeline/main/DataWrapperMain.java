...
import edu.wpi.mhtc.util.helpers.UnZip;
import edu.wpi.mhtc.util.pipeline.wrappers.BEADownload;
import edu.wpi.mhtc.util.pipeline.wrappers.BLSDownload;
import edu.wpi.mhtc.util.pipeline.wrappers.DOLDownload;
import edu.wpi.mhtc.util.pipeline.wrappers.DataGovDownload;
import edu.wpi.mhtc.util.pipeline.wrappers.EIADownload;
import edu.wpi.mhtc.util.pipeline.wrappers.IPEDSDownload;
import edu.wpi.mhtc.util.pipeline.wrappers.URLDownload;
import edu.wpi.mhtc.util.pipeline.wrappers.WebTableWrapper;
...
//		//2015
//		WebTableWrapper.download("http://www.cnbc.com/id/101747925", ".csvData.data", "tmp/cnbc-15-overall-ranks.xls", Arrays.asList(-1));
