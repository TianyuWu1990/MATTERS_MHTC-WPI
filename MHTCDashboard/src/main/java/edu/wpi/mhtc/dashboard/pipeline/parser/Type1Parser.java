...
//
///**
// * Parser for UnEmployment Insurance Metric
// *
// */
//
////TODO: This parser never worked, and this is not even the right metric.
//// this parser as is corresponds to the file "state_unemp_rate.xls" extracted from taxpolicycenter using URLDownload method 
////
////This metric has to be computed from two different sources. 
////The values need to be calculated before being inserted into the database.
