...
public class DataWrapperMain {
	...
	public static void main(String[] args) throws Exception {
		...
		*/
		WebTableWrapper.download("http://www.nsf.gov/statistics/seind14/index.cfm/state-data/table.htm?table=8", "#my_table", "tmp/8th_grade_performance.xlsx", ",", Arrays.asList(-1));
		WebTableWrapper.download("http://www.nsf.gov/statistics/seind14/index.cfm/state-data/table.htm?table=33", "#my_table", "tmp/bs_workforce.xlsx", ",", Arrays.asList(13));
		WebTableWrapper.download("http://taxfoundation.org/article/2014-state-business-tax-climate-index", ".tablesorter.printImitationTable.plainTable", "tmp/tf-14-tci.xlsx", ",", Arrays.asList(-1));
		WebTableWrapper.download("http://www.cnbc.com/id/100824779", ".csvData.data", "tmp/cnbc-13-overall-ranks.xlsx", ",", Arrays.asList(-1));
	}
